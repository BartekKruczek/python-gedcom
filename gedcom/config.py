...
"""
Configuration for `gedcom.parser.Parser`.

`ParserConfig` is the single place the parser's defaults are defined. The Rust
core has none of its own: it reads them from here, so a value can never be
